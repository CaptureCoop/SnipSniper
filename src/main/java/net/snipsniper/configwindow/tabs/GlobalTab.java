...
public class GlobalTab extends JPanel implements ITab{
    ...
    public void setup(Config configOriginal) {
        ...
        options.add(configWindow.createJLabel(CCStringUtils.format("<html><p>Current Version: %c</p><p>Update Channel: %c</p></html>", SnipSniper.Companion.getVersionString(), channel), JLabel.CENTER, JLabel.CENTER), gbc);
        gbc.gridx = 1;
